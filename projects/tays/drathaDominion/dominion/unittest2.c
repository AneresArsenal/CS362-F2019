...
int main()
{
    ...
    {
        printf("Bug found! Number of action plays not incremented by 1! \n");
        printf("Pre-call number of action plays: %d \n", pre.numActions);
        printf("Post-call number of action plays: %d \n\n", post.numActions);
    }

    // printf("Test case 2: Choice 2 Selected. \n\n");
    ...
    // updated hand should be 4
    if (numHandCards(&post) != 4)
    {
        printf("Bug #1 and #2 found! Redrawn hand not equal to 4! \n");
        printf("Pre-call handCount: %d \n", numHandCards(&pre));
        printf("Post-call handCount: %d \n\n", numHandCards(&post));
    }
